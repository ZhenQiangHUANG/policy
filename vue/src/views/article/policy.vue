<template>
  <div class="app-container">
    ...
    <el-table :data="list" v-loading.body="listLoading" element-loading-text="拼命加载中" border fit
      ...
      <el-table-column align="center" prop="title" label="文章标题" style="width: 20px;"></el-table-column>
      <el-table-column align="center" prop="url" label="文章链接" style="width: 20px;"></el-table-column>
      <el-table-column align="center" prop="content" label="文章内容" style="width: 60px;"></el-table-column>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form class="small-space" :model="tempArticle" label-position="left" label-width="60px"
        ...
        <el-form-item label="文章">
          <el-input type="text" v-model="tempArticle.title">
          </el-input>
          <el-input type="text" v-model="tempArticle.url">
          </el-input>
  ...
  export default {
    ...
    methods: {
      ...
      showUpdate($index) {
        ...
        this.tempArticle.url = this.list[$index].url;
